...
public class CrawlPusherAgent : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(m_OrientationCube_Block.transform.InverseTransformDirection(block_transform.gameObject.GetComponent<Rigidbody>().velocity) - m_OrientationCube_Block.transform.InverseTransformDirection(avgVel));
